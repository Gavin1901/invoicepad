...
export const metadata: Metadata = {
  title: "Handyman Invoice Template - Free PDF Generator",
  description: "Create a handyman invoice for labor, materials, call-out fees, repairs, installs, and small home improvement jobs. Free PDF generator.",
  alternates: { canonical: "https://invoicepad.net/handyman-invoice-template" },
};

export default function Page() {
  const lineItems = ['Labor hours', 'Materials and hardware', 'Call-out fee', 'Repairs', 'Installation work'];
  const faq = [
    { q: "Is this handyman invoice template free?", a: "Yes. InvoicePad lets you create a professional PDF invoice for free with no sign-up and no watermark." },
  ...
  return (
    <SiteShell>
      ...
      <main className="mx-auto max-w-3xl px-4 py-10">
        ...
        <h1 className="mt-4 text-3xl font-extrabold tracking-tight text-slate-900">Handyman Invoice Template</h1>
        <p className="mt-3 text-lg leading-8 text-slate-600">Create a handyman invoice for labor, materials, call-out fees, repairs, installs, and small home improvement jobs. Free PDF generator.</p>
        ...
        <section className="mt-10 prose prose-slate max-w-none">
          <h2>How to use this handyman invoice template</h2>
