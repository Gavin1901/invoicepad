...
export const metadata: Metadata = {
  title: "SEO Service Invoice Template - Free PDF Generator",
  description: "Create a clean SEO service invoice for audits, monthly retainers, content optimization, technical SEO, and link building. Free, no sign-up, no watermark.",
  alternates: { canonical: "https://invoicepad.net/seo-service-invoice-template" },
};

export default function Page() {
  const lineItems = ['Technical SEO audit', 'Monthly SEO retainer', 'Content optimization', 'Keyword research', 'Link building outreach'];
  const faq = [
    { q: "Is this seo service invoice template free?", a: "Yes. InvoicePad lets you create a professional PDF invoice for free with no sign-up and no watermark." },
  ...
  return (
    <SiteShell>
      ...
      <main className="mx-auto max-w-3xl px-4 py-10">
        ...
        <h1 className="mt-4 text-3xl font-extrabold tracking-tight text-slate-900">SEO Service Invoice Template</h1>
        <p className="mt-3 text-lg leading-8 text-slate-600">Create a clean SEO service invoice for audits, monthly retainers, content optimization, technical SEO, and link building. Free, no sign-up, no watermark.</p>
        ...
        <section className="mt-10 prose prose-slate max-w-none">
          <h2>How to use this seo service invoice template</h2>
